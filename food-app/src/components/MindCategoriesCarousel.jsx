  ...
  return (
    <div className="relative">
      <button
        ...
        className={`absolute left-0 top-1/2 z-20 -translate-y-1/2 rounded-full border p-2 text-white shadow-2xl transition hover:-translate-x-1 hover:bg-orange-500/90 ${
          darkMode
            ...
            <button
              ...
              className={`group min-w-[150px] flex-shrink-0 rounded-[32px] border px-5 py-5 text-left transition duration-300 will-change-transform ${
                active
                  ...
                  : darkMode
                  ? "border-slate-700 bg-slate-900 text-slate-200 hover:-translate-y-1 hover:border-slate-600 hover:bg-slate-800"
      ...
      <button
        type="button"
        onClick={() => handleScroll(1)}
        className={`absolute right-0 top-1/2 z-20 -translate-y-1/2 rounded-full border p-2 text-white shadow-2xl transition hover:translate-x-1 hover:bg-orange-500/90 ${
          darkMode
            ? "border-slate-700 bg-slate-950/85"
            : "border-slate-300 bg-white/95 text-slate-900"
