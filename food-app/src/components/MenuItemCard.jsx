        ...
        <div className="flex-1 p-6 md:p-7">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            {isUnavailable ? (
              ...
              <button
                disabled
                className={`cursor-not-allowed rounded-2xl px-7 py-4 text-sm font-black uppercase tracking-[0.2em] ${darkMode ? "bg-slate-600/70 text-slate-200" : "bg-slate-200 text-slate-600"}`}
              >
