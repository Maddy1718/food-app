function CategorySidebar({ categories, activeCategory, onSelectCategory, darkMode }) {
  return (
    <div className="hidden xl:block sticky top-28 h-[calc(100vh-7rem)] overflow-y-auto pr-4">
      <div className={`rounded-[32px] border p-5 shadow-xl ${darkMode ? "border-slate-700 bg-slate-900" : "border-slate-200 bg-white"}`}>
        <h3 className={`mb-5 text-xl font-black ${darkMode ? "text-white" : "text-slate-900"}`}>Menu categories</h3>
