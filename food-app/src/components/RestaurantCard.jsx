...
function RestaurantCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="group overflow-hidden rounded-[30px] border border-slate-200 bg-white shadow-[0_4px_25px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(0,0,0,0.15)] dark:border-slate-700 dark:bg-slate-900"
      >
        ...
        <div className="p-6">
          ...
          {/* DESCRIPTION */}
          <p className="mt-4 line-clamp-2 text-sm leading-relaxed text-slate-500 dark:text-slate-300">
