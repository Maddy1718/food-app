    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        {!cartItems.length ? (
          ...
          <div className={`rounded-[36px] border p-16 text-center shadow-xl ${darkMode ? "border-slate-700 bg-slate-900" : "border-slate-200 bg-white"}`}>
            ...
            <h2 className={`mt-6 text-3xl font-black ${darkMode ? "text-white" : "text-slate-900"}`}>
              Cart is Empty
            </h2>
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_380px]">
            ...
            <div className="space-y-6">
              ...
              {cartItems.map(
                (item, index) => (
                  ...
                  <div
                    key={`${item.id}-${index}`}
                    className={`rounded-[32px] border p-5 shadow-lg ${darkMode ? "border-slate-700 bg-slate-900" : "border-slate-200 bg-white"}`}
                  >
            ...
            {/* RIGHT */}
            <div className={`sticky top-28 h-fit rounded-[36px] border p-8 shadow-xl ${darkMode ? "border-slate-700 bg-slate-900" : "border-slate-200 bg-white"}`}>
              ...
              <div className="mt-8 space-y-5">
                ...
                <div className={`flex items-center justify-between ${darkMode ? "text-slate-300" : "text-slate-600"}`}>
                ...
                {/* TOTAL */}
                <div className={`flex items-center justify-between border-t pt-5 text-2xl font-black ${darkMode ? "border-slate-700 text-white" : "border-slate-200 text-slate-900"}`}>
